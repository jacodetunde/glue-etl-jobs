...
download_zip_file() {
    ...
    wget -q https://github.com/jacodetunde/glue-etl-jobs/blob/main/csv_to_s3/csv_to_s3.zip
}
...
execute_python_script() {
    ...
    local bucket_name="csv-to-s3-project-jacob-jo"
    local object_key="dirty_store_transactions/dirty_store_transactions.csv"
    local data_url="https://raw.githubusercontent.com/jacodetunde/glue-etl-jobs/main/csv_to_s3/dirty_store_transactions.csv"
